    ...
    <div class="card" style="padding: 2rem;">
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" id="subject" name="subject" class="input-standard" placeholder="Wpisz krótki temat..." required>
            </div>
            <div class="form-group">
                <label class="form-label" for="server_id">Dotyczy serwera</label>
                <select name="server_id" id="server_id" class="select-standard">
        ...
        <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
            ...
            <a href="{{ route('support.index') }}" class="btn" style="border: 1px solid var(--border-color);">Anuluj</a>
        </div>
    </div>
</form>
@endsection