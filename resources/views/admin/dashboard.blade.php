...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-top: 30px;">
    <div class="card">
        <h2 class="h3">Ostatnio utworzone serwery</h2>
    ...
    <div class="card">
        ...
        <a href="{{ route('admin.logs.index') }}" class="btn btn-access" style="width: 100%; margin-top: 15px; text-align: center;">Zobacz wszystkie logi</a>
    </div>
</div>
@endsection
